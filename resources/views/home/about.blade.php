    ...
    <div class="container-fluid">
		...
		<div class="row justify-content-center">
			<div class="col-md-7">
				 ...
				 <div class="row mb-5">
					<div class="col-md-7">
						<img src="{{asset('home_asset/images/img_2.jpg')}}" alt="Images" class="img-fluid">
					</div>
				...
				<div class="row site-section">
					<div class="col-md-6 col-lg-6 col-xl-4 text-center mb-5">
						<img src="{{asset('home_asset/images/person_1.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
						...
						<p>
							<a href="#" class="pl-0 pr-3"><span class="icon-logout"></span></a>
							<a href="#" class="pl-3 pr-3"><span class="icon-instagram"></span></a>
							<a href="#" class="pl-3 pr-3"><span class="icon-facebook"></span></a>
						</p>
					</div>
					<div class="col-md-6 col-lg-6 col-xl-4 text-center mb-5">
						<img src="{{asset('home_asset/images/person_2.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
					...
					<div class="col-md-6 col-lg-6 col-xl-4 text-center mb-5">
						<img src="{{asset('home_asset/images/person_4.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
